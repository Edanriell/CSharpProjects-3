...
namespace ImagesFromAFibonacciSequence
{
    public static class FibonacciConsole
    {
        public static void Main()
        {
            ...
            do
            {
                ...
                Task.Run(
                    () => GenerateImageSequences(tempImagePath, phi, imageCount, token),
                    token
                );
            } while (true);
        }

        private static async Task GenerateImageSequences(
