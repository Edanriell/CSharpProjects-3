...
public class ToDoDbContext : DbContext
{
    ...
    private IEnumerable<ActivityLog> GenerateActivityLog()
    {
        ...
        {
            var changedProperties = entity.Properties.Where(
                p => p.IsModified && !p.CurrentValue!.Equals(p.OriginalValue)
            );
        ...
        string GetPrimaryKey(EntityEntry entity)
        {
            return entity.Metadata
                .FindPrimaryKey()!
                .Properties.Select(p => entity.Property(p.Name).CurrentValue)
                .Single()!
                .ToString()!;
        }
    }
